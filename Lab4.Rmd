...
The variables are normal because the p-values are all above 0.05 for each group.Despite the graphs not looking normally distributed the test shows normality. 
